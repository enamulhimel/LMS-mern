...
const CourseDetails = () => {
  ...
  const {allCourses,calculateRating,calculateNoOfLectures,calculateCourseTime,calculateChapterTime,currency} = useContext(AppContext)
  ...
  return courseData ?  (
    ...
    <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
      ...
      <div className="max-w-xl z-10 text-gray-500">
        ...
        <p className="pt-4 md:text-base text-sm" dangerouslySetInnerHTML={{__html: courseData.courseDescription ? courseData.courseDescription.slice(0,200):""}}></p>

        {/* review and ratings */}
        <div className="flex items-center space-x-2 pt-3 pb-1 font-sm ">
                ...
                <div className="pt-8 text-gray-800">
                  ...
                  <div className="pt-5">
                      {courseData.courseContent.map((chapter,index)=>( <div key={index} className="border border-gray-300 bg-white mb-2 rounded">
